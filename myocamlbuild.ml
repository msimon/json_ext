(* OASIS_START *)
(* DO NOT EDIT (digest: 9a19ce7506f4b6d546bdd09f8a11b975) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("json_ext.server", ["server/src"]);
          ("json_ext.server.syntax", ["server/syntax"]);
          ("json_ext.client", ["client/src"]);
          ("json_ext.client.syntax", ["client/syntax"])
       ];
     lib_c = [];
     flags = [];
     includes = [];
