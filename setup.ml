...
(* OASIS_START *)
(* DO NOT EDIT (digest: d666b258828e008e8727df28b71cd5ac) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Library
                 ({
                     cs_name = "json_ext.server.syntax";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                     cs_name = "json_ext.client.syntax";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "Av2\129ò#-ÉR\131\021\137µ¬øï";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
